...
"}")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../Loopster/CloseButton.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../Loopster/MiniButton.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.lblogo.setText("")
        self.lblogo.setPixmap(QtGui.QPixmap("../Loopster/logowhite.png"))
...
"}")
        self.p1_s2.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../Loopster/play.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("../Loopster/play2.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
